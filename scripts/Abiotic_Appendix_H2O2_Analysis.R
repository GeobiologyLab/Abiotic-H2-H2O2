...
df0 <- read.csv("table_45_water.csv")
...
ggplot(df3, aes(x=Time, y=H2O2, fill=Sample)) + 
  ...
  theme_bw() + 
  scale_fill_brewer(palette="Dark2") +
  ggtitle("Hydrogen Peroxide Production - 106-150μm") +
  xlab("Time (hours)") +
  ylab("H2O2 (μM)") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_color_manual(values=cbPalette) + ylim(0,15)
...
ggplot(df4, aes(x=Time, y=H2O2, fill=Sample)) + 
  ...
  theme_bw() + 
  scale_fill_brewer(palette="Dark2") +
  ggtitle("Hydrogen Peroxide Production - H2O Controls") +
  xlab("Time (hours)") +
  ylab("H2O2 (μM)") +
  theme(plot.title=element_text(hjust=0.5)) +
  scale_color_manual(values=cbPalette) + ylim(0,15)
...
ggplot(df5, aes(x=Time, y=H2O2, fill=Sample)) + 
  ...
  theme_bw() + 
  #scale_fill_brewer(palette="Dark2") +
  ggtitle("Hydrogen Peroxide Production - <45μm Seawater") +
  xlab("Time (hours)") +
  ylab("H2O2 (μM)") +
  theme(plot.title=element_text(hjust=0.5)) +
